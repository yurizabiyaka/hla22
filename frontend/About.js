...
const About = {
    ...
    <tr> <td > <ul> 
        ...
        <li> <a href=https://www.npmjs.com/package/debounce> JS Debounce</a> задержка реактивности запроса данных </li>
        ...
        <li> <a href="https://www.docker.com"> docker </a> чтобы упростить деплой </li> 
        <li> <a href="https://www.docker.com"> docker-compose </a> чтобы всё это взлетело </li> 
        </ul>
    </td> </tr>
    </table>
    </div>`
